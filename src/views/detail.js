      ...
      <Box as={ScrollView} p={16}>
        ...
        <Box flexDirection="row" mt={24}>
          <ActionButton disabled={!data}>
            <Sound width={30} height={30} color={theme.colors.textLight} />
          </ActionButton>
          <ActionButton disabled={!data} ml={12}>
            <Favorite  width={30} height={30} color={theme.colors.textLight} />
          </ActionButton>
          <ActionButton disabled={!data} ml="auto">
            <Hand width={30} height={30} color={theme.colors.textLight} />
